...
public class BatteryLevelTextView extends TextView implements
    ...
    private boolean mShowWhileCharging;
    ...
    public void setShowWhileCharging(boolean showWhileCharging) {
        mShowWhileCharging = showWhileCharging;
        updateVisibility();
    }
    ...
    private void updateVisibility() {
        boolean showNextPercent = mPercentMode == BatteryController.PERCENTAGE_MODE_OUTSIDE
                || (mBatteryCharging && (mShowWhileCharging 
                        || mPercentMode == BatteryController.PERCENTAGE_MODE_INSIDE));
